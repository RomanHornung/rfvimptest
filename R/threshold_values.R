...
##' myvals <- critical_values(p0 = 0.06, p1 = 0.04, A = 0.1, B = 10, Mmax = 200, type = "SAPT")
##' myvals
##' 
...
##' summary(mod)
##' 
##' # Derive a statistic of interest from the model. Here, the negative AIC is used as a statistic to be maximised.
##' stat <- -1 * mod$aic
##' 
